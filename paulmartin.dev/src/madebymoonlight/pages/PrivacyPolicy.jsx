...
import { getByUrlName } from '../data/games'
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <p>
          Paul Martin (Made by Moonlight) built the {model.name} app as a{' '}
          {model.pricingModel} app. This SERVICE is provided by Paul Martin (Made
          by Moonlight) at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at The 16 Spaces unless
        ...
        <p>This policy is effective as of 2020-09-15</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do not
          hesitate to contact me at MadeByMoonlightGames@gmail.com.
        </p>
        <p>
